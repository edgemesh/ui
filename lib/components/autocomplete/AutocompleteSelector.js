...
var AutocompleteSelector = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
	...
	_createClass(AutocompleteSelector, [{
		...
		value: function render() {
			...
			var selectorItemStyles = _props.selectorItemStyles;
			...
			return _react2.default.createElement(
				_.Paper,
				{ ref: 'container', style: [styles.paper, { maxHeight: maxSelectorHeight }], innerStyle: styles.paperInner, fullWidth: true, zIndex: 1001 },
