...
var Select = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    _createClass(Select, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var defaultLabel = _props2.defaultLabel;
        ...
        value: function render() {
            ...
            var hoverBackground = _props3.hoverBackground;
            var placeholderColor = _props3.placeholderColor;
            var textColor = _props3.textColor;
            var fullWidth = _props3.fullWidth;
            var style = _props3.style;
            var placeholderStyle = _props3.placeholderStyle;
            var dropdownContainerStyle = _props3.dropdownContainerStyle;
            var disabledStyle = _props3.disabledStyle;
            var minWidth = _props3.minWidth;
            var maxWidth = _props3.maxWidth;
            var floatingLabel = _props3.floatingLabel;
            var backgroundColor = _props3.backgroundColor;
            var floatingLabelColor = _props3.floatingLabelColor;
            var disabledTextColor = _props3.disabledTextColor;
            var disabledPlaceholderColor = _props3.disabledPlaceholderColor;
            var disabledBackground = _props3.disabledBackground;
        ...
        value: function _renderOptions() {
            ...
            var optionContainerStyle = _props4.optionContainerStyle;
            var maxSelectorHeight = _props4.maxSelectorHeight;
            var defaultLabel = _props4.defaultLabel;
            var defaultValue = _props4.defaultValue;
            var _state2 = this.state;
            var selectionIndex = _state2.selectionIndex;
            var currentSelection = _state2.currentSelection;
