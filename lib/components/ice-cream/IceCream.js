...
var Chips = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
	...
	_createClass(Chips, [{
		...
		value: function _getPlacement() {
			...
			var hPosition = _props2.hPosition;
			var vPosition = _props2.vPosition;
		...
		value: function pushMessage(message, accent) {
			...
			var fontColor = _props3.fontColor;
	...
	hPosition: _react.PropTypes.oneOf(['left', 'right']),
	vPosition: _react.PropTypes.oneOf(['top', 'bottom']),
	fontColor: _react.PropTypes.string,
