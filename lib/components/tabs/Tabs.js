...
var Tab = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    // Tabs configuration
    defaultTab: _propTypes2.default.number, // Index of the children array
    tabStyles: _propTypes2.default.object, // Pass style to all child `Tab` elements
    tabDisabledStyles: _propTypes2.default.object, // Pass disabled style to all child `Tab` elements
    tabSelectedStyles: _propTypes2.default.object, // Pass style to the selected `Tab` element
    tabContainerStyles: _propTypes2.default.object, // Pass style to the container of the `Tab` elements
    depth: _propTypes2.default.number, // Sets the depth of the outer `Paper` element of the Tabs component
    contentContainerStyles: _propTypes2.default.object, // Pass style to the content container of the `Tabs` elements
    accent: _propTypes2.default.string, // InkBar and active `Tab` text color
    contentContainerClassName: _propTypes2.default.string, // Just here for webkit scrollbar support
    fixedWidthTabs: _propTypes2.default.bool, // True: Children `Tab` elements are fixed equal width --
    // False: Children `Tab` elements are auto width aligned flex-start
    // Event
    onSelect: _propTypes2.default.func // Optional onSelect event override for all `Tab` components --
