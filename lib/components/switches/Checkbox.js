...
var Checkbox = (0, _radium2.default)(_class = (0, _BaseSwitch2.default)(_class = (_temp = _class2 = function (_Component) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ ref: 'ripple', handleMouseDown: function handleMouseDown() {}, overflowHidden: false, rippleColor: checkColor, speed: 150 },
					...
					_react2.default.createElement(_.Icon, {
						...
						size: size,
						color: checkColor,
						style: [styles.check, isSwitched && styles.isSwitched] })
				)
			);
		}
	}]);
