...
var BaseDialog = exports.BaseDialog = function BaseDialog(ComposedComponent, ref) {
	...
	return _temp2 = _class = function (_Component) {
		...
		_createClass(_class, [{
			...
			value: function render() {
				var show = this.state.show,
				    ...
				    renderInBody = _props.renderInBody,
				    lockScrolling = _props.lockScrolling;
		...
		renderInBody: _propTypes2.default.bool,
		dismissOnClickAway: _propTypes2.default.bool,
		lockScrolling: _propTypes2.default.bool,
		transition: _propTypes2.default.oneOf(['sticky-top', 'sticky-bottom', 'slide-in', 'scale-in', 'scale-out', 'sign-flip', 'flipX', 'flipY', 'slide-and-rotate']),
		// Events
