...
var AutocompleteSelector = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
	...
	_createClass(AutocompleteSelector, [{
		...
		value: function render() {
			...
			var _props = this.props,
			    ...
			    accentFontColor = _props.accentFontColor,
			...
			options = options.map(function (option, i) {
				return _react2.default.createElement(
					'div',
					{
						...
						style: [styles.optionItem, i === 0 && { paddingTop: 16 }, selectorItemStyles, i == selectionIndex && { backgroundColor: accentColor, color: accentFontColor }]
					},
					option.label
				);
			});
	...
	selectorItemStyles: _propTypes2.default.object,
	accentColor: _propTypes2.default.string,
	accentFontColor: _propTypes2.default.string,
	...
	accentFontColor: _colors.colors.grey700,
