...
var Tab = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var tabStyles = _props.tabStyles;
            var tabSelectedStyles = _props.tabSelectedStyles;
            var accent = _props.accent;
            var onSelect = _props.onSelect;
            var style = _props.style;
            var fixedWidthTabs = _props.fixedWidthTabs;
            var contentContainerStyles = _props.contentContainerStyles;
            var tabContainerStyles = _props.tabContainerStyles;
            var contentContainerClassName = _props.contentContainerClassName;
            var tabDisabledStyles = _props.tabDisabledStyles;
        ...
        value: function handleSelect(index) {
            ...
            var selectedTabWidth = _getSelectedTabWidth2.selectedTabWidth;
            var selectedTabLeft = _getSelectedTabWidth2.selectedTabLeft;
        ...
        value: function _renderInkBar() {
            ...
            var selectedTabWidth = _state.selectedTabWidth;
            var selectedTabLeft = _state.selectedTabLeft;
            var tabsContainerWidth = _state.tabsContainerWidth;
