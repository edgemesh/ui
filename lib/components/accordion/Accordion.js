...
var Accordion = (0, _radium2.default)(_class = (_temp2 = _class2 = function (_Component) {
	...
	_createClass(Accordion, [{
		...
		value: function render() {
			...
			var expandDirection = _props.expandDirection;
			...
			var topExpandContent = void 0;
			var bottomExpandContent = void 0;
		...
		value: function _renderExpandContent() {
			...
			var expandAmount = _props2.expandAmount;
			var expandDirection = _props2.expandDirection;
			var expandContent = _props2.expandContent;
			var expandContentStyle = _props2.expandContentStyle;
			var expandContentContainerStyle = _props2.expandContentContainerStyle;
			var expandIsOverlay = _props2.expandIsOverlay;
	...
	expandDirection: _react.PropTypes.oneOf(['up', 'down']),
	expandIsOverlay: _react.PropTypes.bool, // If true expand content will be position: 'absolute'
	expandContent: _react.PropTypes.any,
	expandContentStyle: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.object, _react2.default.PropTypes.array]),
	expandContentContainerStyle: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.object, _react2.default.PropTypes.array]),
	expandedOnMount: _react.PropTypes.bool,
	transitionSpeed: _react.PropTypes.number,
	disabled: _react.PropTypes.bool,
	disabledStyle: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.object, _react2.default.PropTypes.array]),
	// Events
	onExpandOpen: _react.PropTypes.func,
	onExpandClose: _react.PropTypes.func
